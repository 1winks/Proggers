			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					entry=none
						...
						width = \textwidth,
						colspec = {|X[6,1]|X[6,1]|X[20,1]},
						rowhead = 1,
					}
					\hline \SetCell[c=3]{c}{\textbf{ponuditelj}  \\ \hline[3pt]
					\hline
					\multicolumn{3}{|c|}{\textbf{ponuditelj}} \\
					\bottomrule[2pt]					\cellcolor{green!25}korisnickoIme & VARCHAR &Skup znakova koji se koriste za prepoznavanje i pristup\\
					\hline
				...
				\begin{longtblr}{ |p{4cm}|p{3cm}|p{5cm}|  }
				\hline
				\multicolumn{3}{|c|}{\textbf{ponuditelj}} \\
				\bottomrule[2pt]
