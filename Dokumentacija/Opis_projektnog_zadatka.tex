\chapter{Opis projektnog zadatka}
		...
		\textit{Cilj ovog projektnog zadatka je razvoj programske podrške za stvaranje web aplikacije "Što želiš čitati" koja će korisnicima omogućiti pretragu i pronalaženje knjiga koje se prodaju u određenim trgovinama. Normalnim korisnicima bit će omogućeno pojednostavljeno pretraživanje knjiga i trgovina koje prodaju određene knjige, dok će registriranim korisnicima biti omogućeno prodavanje i prevođenja knjiga po narudžbi.}
		
		\textit{Web aplikacija namijenjena je za dvije vrste korisnika: neregistrirani i registrirani korisnik.}
